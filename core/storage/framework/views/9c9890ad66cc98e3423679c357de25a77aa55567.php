<script src="<?php echo e(global_asset('assets/landlord/admin/js/dropzone.js')); ?>"></script>
<?php
    ...
    (function () {
        ...
        $(document).ready(function (){
            ...
            function deleteImage(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo e($file_delete_route); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        img_id : $('.image_id').text(),
                        user_type: "<?php echo e($user_type); ?>"
                    },
            ...
            $(document).on('click', '.img_alt_submit_btn', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e($file_alt_change_route); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
            ...
            function loadAllImages() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e($all_file_fetch_route); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
            ...
            $(document).on('click','#loadmorewrap',function (){
                ...
                $('#loadmorewrap button').text('<?php echo e(__('Loading...')); ?>');
                $.ajax({
                    type: "POST",
                    url: "<?php echo e($file_load_more_route); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        'skip' : skipp,
                        user_type: "<?php echo e($user_type); ?>"
                    ...
                    success: function (data) {
                        ...
                        $('#loadmorewrap button').text('<?php echo e(__('Loadmore')); ?>');
                    },
                    error: function (error) {
...
<?php /**PATH C:\laragon\www\core\resources\views/components/media-upload/js.blade.php ENDPATH**/ ?>