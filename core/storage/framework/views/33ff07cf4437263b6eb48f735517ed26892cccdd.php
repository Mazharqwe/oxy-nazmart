...
<?php if(tenant() && get_static_option_central('google_tag_manager_tenant') == 'on'): ?>
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo e(get_static_option_central('google_analytics_gt4_ID')); ?>"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', "<?php echo e(get_static_option_central('google_analytics_gt4_ID')); ?>");
    </script>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\core\Modules/Integrations\Resources/views/tracking-before-head.blade.php ENDPATH**/ ?>