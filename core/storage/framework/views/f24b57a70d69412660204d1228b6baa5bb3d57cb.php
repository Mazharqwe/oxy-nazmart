    ...
    <div class="container">
        ...
        <div class="row mt-4">
            ...
            <?php if(get_static_option('up_coming_themes_frontend')): ?>
                <?php $__currentLoopData = range(8, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\core\plugins\PageBuilder/views/landlord/addons/common/theme.blade.php ENDPATH**/ ?>